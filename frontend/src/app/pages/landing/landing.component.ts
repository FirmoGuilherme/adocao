          ...
          <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Encontre o pet certo,</span>
    ...
    <div class="py-16 bg-background">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <h2 class="text-base text-secondary font-semibold tracking-wide uppercase">Processo de Adoção</h2>
        ...
        <div class="mt-16">
          <div class="grid grid-cols-1 gap-8 md:grid-cols-3 text-center">
            <div class="card p-8 flex flex-col items-center">
              ...
              <h3 class="text-xl font-bold text-gray-900 mb-2">Explore os Pets</h3>
              <p class="text-gray-500">Conheça centenas de cães e gatos esperando um lar, vindos de ONGs e abrigos verificados.</p>
            </div>
            ...
            <div class="card p-8 flex flex-col items-center transform md:-translate-y-4">
              ...
              <h3 class="text-xl font-bold text-gray-900 mb-2">Verifique a Compatibilidade</h3>
              <p class="text-gray-500">Faça nosso quiz inteligente para descobrir quais pets combinam com seu estilo de vida, moradia e rotina.</p>
            </div>

            <div class="card p-8 flex flex-col items-center">
              <div class="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 text-accent text-2xl font-bold mb-6">3</div>
              <h3 class="text-xl font-bold text-gray-900 mb-2">Candidate-se à Adoção</h3>
              <p class="text-gray-500">Envie sua candidatura. Acompanhe o status de forma transparente, comunicando-se diretamente com o abrigo.</p>
            </div>
          </div>
        </div>
      </div>
