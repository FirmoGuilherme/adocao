      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex gap-8">
        ...
        <aside class="w-64 hidden md:block">
           <div class="bg-white rounded-2xl shadow-soft p-4 flex flex-col gap-2">
             ...
             <a href="#" class="p-3 text-gray-600 hover:bg-gray-50 rounded-xl flex items-center gap-3 font-medium">
               <span>📄</span> Candidaturas <span class="ml-auto bg-red-100 text-red-600 py-0.5 px-2 rounded-full text-xs">11</span>
             </a>
             <a href="#" class="p-3 text-gray-600 hover:bg-gray-50 rounded-xl flex items-center gap-3 font-medium">
        ...
        <main class="flex-grow">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
             ...
             <div class="bg-white p-6 rounded-2xl shadow-soft">
               <p class="text-sm font-medium text-gray-500 mb-1">Adoções (Mês)</p>
               <h3 class="text-3xl font-extrabold text-blue-600">7</h3>
             </div>
          </div>

          <h2 class="text-xl font-bold text-gray-900 mb-4">Revisão de Candidaturas Urgentes</h2>
          
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-gray-100 p-4 rounded-xl">
               <div class="flex justify-between items-center mb-4">
                 <h3 class="font-bold text-gray-700 uppercase tracking-wide text-xs">Novas (4)</h3>
               </div>
               <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-3 cursor-pointer hover:shadow-md transition">
                 <div class="flex justify-between items-start mb-2">
                   ...
                   <span class="badge badge-success text-xs">98% Compatível</span>
                 </div>
                 <p class="text-xs text-gray-500 mb-3">Candidata para <span class="font-bold text-primary">Luna</span></p>
                 <div class="text-xs text-gray-400 flex items-center gap-1">
                   <span>🏠</span> Apartamento · <span>🧑</span> Sem Crianças
                 </div>
               </div>
               <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 cursor-pointer hover:shadow-md transition">
                 <div class="flex justify-between items-start mb-2">
                   ...
                   <span class="badge badge-warning text-xs">75% Compatível</span>
                 </div>
                 <p class="text-xs text-gray-500 mb-3">Candidato para <span class="font-bold text-primary">Thor</span></p>
                 <div class="text-xs text-red-500 flex items-center gap-1 font-medium bg-red-50 p-1 rounded">
                   <span>⚠️</span> Casa sem cerca?
                 </div>
               </div>
            </div>
            ...
            <div class="bg-gray-100 p-4 rounded-xl">
               <div class="flex justify-between items-center mb-4">
                 <h3 class="font-bold text-gray-700 uppercase tracking-wide text-xs">Em Entrevista (3)</h3>
               </div>
               <div class="bg-white p-4 rounded-lg shadow-sm border border-l-4 border-l-blue-400 cursor-pointer hover:shadow-md transition">
                 <div class="flex justify-between items-start mb-2">
                   ...
                   <span class="text-xs text-gray-400">Hoje, 14:00</span>
                 </div>
                 <p class="text-xs text-gray-500 mb-3">Candidato para <span class="font-bold text-primary">Mia</span></p>
                 <button class="w-full text-xs font-bold text-blue-600 bg-blue-50 py-2 rounded">Entrar na Videochamada</button>
               </div>
            </div>

            <div class="bg-gray-100 p-4 rounded-xl border border-green-200 bg-green-50">
               <div class="flex justify-between items-center mb-4">
                 <h3 class="font-bold text-green-800 uppercase tracking-wide text-xs">Aprovadas (3)</h3>
               </div>
               <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 cursor-pointer hover:shadow-md transition opacity-80">
                 <div class="flex justify-between items-start mb-2">
                   <h4 class="font-bold text-gray-900 text-sm">Luísa Almeida</h4>
                 </div>
                 <p class="text-xs text-gray-500 mb-3">Adotando <span class="font-bold text-secondary">Bento</span></p>
                 <span class="text-xs font-bold text-green-600 flex items-center gap-1">
                   <span>🎉</span> Contrato Assinado
                 </span>
               </div>
            </div>
          </div>

          <h2 class="text-xl font-bold text-gray-900 mb-4">Alertas da Plataforma</h2>
          <div class="bg-yellow-50 border border-yellow-200 p-4 rounded-xl flex items-start gap-4">
             <span class="text-2xl mt-1">⚠️</span>
             <div>
               <h4 class="font-bold text-yellow-800">Perfis Incompletos Detectados</h4>
               <p class="text-sm text-yellow-700 mt-1">2 dos seus pets estão sem registros de vacinação. Eles não serão visíveis para adotantes até serem corrigidos.</p>
               <button class="mt-2 text-sm font-bold text-yellow-900 hover:underline">Revisar perfis</button>
             </div>
          </div>
        </main>
      </div>
